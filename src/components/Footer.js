...
import technology4 from "./images/imgs/technology4.jpg"
import technology8 from "./images/imgs/technology8.jpg"
import technology3 from "./images/imgs/technology3.jpg"
import technology1 from "./images/imgs/technology1.jpg"
import footerImg from "./images/imgs/footer.png"
import harvestFooter from "./images/imgs/harvest footer.png"
    ...
    return (
        ...
        <div class="foot-left">
            ...
            <div class="f-1">
                <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 355.64 366.57">
                    ...
                    <polyline class="cls-4" points="32.66 290.61 105.84 290.61 244.89 290.61 322.98 290.61" /><text
                        ...
                        <tspan xmlSpace="preserve">HEALTHY HARVEST</tspan>
                    </text>
            ...
            <div class="f-2">
                ...
                <div class="f-img"><img src={technology1} alt=""/></div>
                <div class="f-img"><img src={technology8} alt=""/></div>
                <div class="f-img"><img src={technology3} alt=""/></div>
                <div class="f-img"><img src={technology4} alt=""/></div>
            </div>
        </div>
        <div class="foot-main">
            <img src={footerImg} alt="tree"></img>
            <img src={harvestFooter}alt="Patent"></img>
        </div>
